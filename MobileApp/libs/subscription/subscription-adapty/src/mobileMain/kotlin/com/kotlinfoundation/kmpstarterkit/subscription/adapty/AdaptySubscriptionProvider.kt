    ...
    private fun AdaptySubscriptionOfferPhase.asIntroductoryOffer(): IntroductoryOffer? {
        ...
        return IntroductoryOffer(
            ...
            periodUnit = when (subscriptionPeriod.unit) {
                AdaptyPeriodUnit.DAY -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.DAY
                AdaptyPeriodUnit.WEEK -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.WEEK
                AdaptyPeriodUnit.MONTH -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.MONTH
                AdaptyPeriodUnit.YEAR -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.YEAR
