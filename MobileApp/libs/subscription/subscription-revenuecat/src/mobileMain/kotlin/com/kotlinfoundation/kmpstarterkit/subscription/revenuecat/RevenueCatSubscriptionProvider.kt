...
import com.kotlinfoundation.kmpstarterkit.subscription.api.GrantedAccess
...
import com.kotlinfoundation.kmpstarterkit.subscription.api.SubscriptionProviderUser
import com.kotlinfoundation.kmpstarterkit.subscription.api.runCatchingSuspend
...
internal class RevenueCatSubscriptionProvider : SubscriptionProvider {
    ...
    private fun Period.periodUnit(): com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit? = when (unit) {
        PeriodUnit.DAY -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.DAY
        PeriodUnit.WEEK -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.WEEK
        PeriodUnit.MONTH -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.MONTH
        PeriodUnit.YEAR -> com.kotlinfoundation.kmpstarterkit.subscription.api.PeriodUnit.YEAR
        PeriodUnit.UNKNOWN -> null
    }
